...
class Ui_channelExportWindow(object):
    ...
    def retranslateUi(self, channelExportWindow):
        ...
        self.saveToSet_btn.setText(QtGui.QApplication.translate("channelExportWindow", "To Set", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.removeSelected_btn.setText(QtGui.QApplication.translate("channelExportWindow", "Selected", None, QtGui.QApplication.UnicodeUTF8))
        self.removeAll_btn.setText(QtGui.QApplication.translate("channelExportWindow", "All", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_4.setTitle(QtGui.QApplication.translate("channelExportWindow", "Range", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("channelExportWindow", "Range:", None, QtGui.QApplication.UnicodeUTF8))
        self.currentTimeToEnd_btn.setText(QtGui.QApplication.translate("channelExportWindow", "Current to end ▲ ", None, QtGui.QApplication.UnicodeUTF8))
        self.currentTimeToStart_btn.setText(QtGui.QApplication.translate("channelExportWindow", "▲ Current to start", None, QtGui.QApplication.UnicodeUTF8))
